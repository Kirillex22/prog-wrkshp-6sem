...
# from routers.fastapi.user_router import *
# from routers.fastapi.transaction_router import *
# from routers.fastapi.report_router import *
# from routers.fastapi.auth_router import *
#
# app = FastAPI(
...
if __name__ == "__main__":
    uvicorn.run("routers.graphql.entrypoints:app", host="localhost", port=8080)
